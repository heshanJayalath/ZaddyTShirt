...
const Cart = ({ setOpenCart }) => {
    ...
    return (
        <div className='fixed top-0 left-0 w-full bg-[#00000056] h-screen z-10'>
            <div className='fixed top-0 right-0 min-h-full md:w-[25%] bg-white flex flex-col justify-between shadow-sm'>
                {
                    cart && cart.length === 0 ? (
