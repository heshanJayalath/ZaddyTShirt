...
const AccountDetail = () => {
  return (
    <div className="max-w-full py-2 mx-8 mt-4 items-center">
      <div className=" w-full text-center  mb-6">
        <h1 className="font-bold text-cyan-900 text-xl"> ADMIN DETAILS </h1>
      </div>

      <div className="md:flex w-full my-4 px-8">
        <div className="w-full text-center md:text-start md:w-4/12">
          <h5 className="font-semibold text-slate-700 py-4">Admin Name</h5>
          <input
