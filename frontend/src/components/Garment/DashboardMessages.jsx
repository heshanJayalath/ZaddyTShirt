...
//     const { garment, isLoading } = useSelector((state) => state.garment);
...
//     return (
//         <div className="w-[80%] bg-white px-6 m-5 h-[85vh] overflow-y-scroll rounded">
//             {!open && (
//                 <>
...
//         navigate(`/garment-dashboard-messages/${id}`);
//         setOpen(true);
//     };
...
//                         return (
//                             <div
//                                 className={`flex w-full my-2 ${item.sender === garmentId ? "justify-end" : "justify-start"
//                                     }`}
//                                 ref={scrollRef}
//                             >
...
//                                     <div>
//                                         <div
//                                             className={`w-max p-2 rounded ${item.sender === garmentId ? "bg-[#000]" : "bg-[#38c776]"
//                                                 } text-[#fff] h-min`}
//                                         >
//                                             <p>{item.text}</p>
//                                         </div>
