    ...
    <div>
      ...
      <div className="ps-72 py-4 bg-blue-50">
        <h2 className="">
          ...
          <span className="text-gray-700 font-medium">Garment Profile </span>
        </h2>
      </div>

      <div className={`${styles.section} bg-white my-4 rounded-lg`}>
        <div className="w-full md:flex gap-4 py-10 justify-between">
          <div className="mb-8 w-full md:w-[25%] bg-white rounded-[8px] shadow-md shadow-blue-300 overflow-y-scroll md:overflow-hidden h-[50vh] md:h-auto  top-10 left-0">
