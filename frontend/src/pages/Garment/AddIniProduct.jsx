      ...
      <div className="bg-gray-100 md:mt-20 md:mx-40 m-5 min-h-screen rounded-2xl shadow-lg max-w-full px-16 py-10  items-center">
        <div class="flex flex-col items-center">
          ...
          <p className="md:text-xl text-sm mt-4 my-8 text-[#002D74]">
            Add your initial product to examine
          </p>
        </div>
        <form >
        {/* first part */}
        <div className="md:flex  md:w-full">
          ...
          <div className="md:w-2/5 md:px-10 px-6 mt-10 items-center justify-center  mb-6 md:mb-2">
            <label
              htmlFor="file-input"
        ...
        <div className="  md:w-full">
          ...
          <div>
            {/* <div className="w-full relative flex ">
                  <label for="xl" className="mx-4">
                    
                    Request 3D Model 
                  </label>
                  <input className="m-1 w " type="checkbox"  id="xl" name="xl" value="xl" />
                </div> */}
          ...
          <button className="bg-[#002D74] rounded-md w-5/12 text-white  py-3 hover:scale-105 duration-300" type='submit'>Add Product</button>
          </dir>
        </div>
        </form>
